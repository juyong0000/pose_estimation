...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            counter    += 1
            depth_img   = cam.stream()
            pcd         = cam.generate(depth_img)
            ...
            pcd, clusters, cluster_ids = clustering(pool, pcd, eps = 0.005, min_points = 11, threshold = 300, no_neighbors = 50, vis = False)
            ...
            for k in range(len(geometry)):
                ...
                print(np.dot(T_base_camera, T_camera_object))
